...
public class GrassTile extends Tile
{
	...
	public GrassTile(int x, int y, int z)
	{
		super(true, x, y, z);
	}
	...
	public void paintOn(GraphicsContext graphics)
	{
		...
		graphics.setFill(hover ? Color.LIGHTGREEN : Color.LIGHTGREEN.darker());
		graphics.fillPolygon(new double[] { x1, x2, x3, x4 }, new double[] { y1, y2, y3, y4 }, 4);
		graphics.setFill(hover ? Color.SADDLEBROWN : Color.SADDLEBROWN.darker());
